...
The repository owner has designated Claude Code as the authoritative AI coordinator for this repository. Use `HANDOFF.md` to leave explicit instructions for Codex when you want it to pick up support work or avoid files you are actively changing.
